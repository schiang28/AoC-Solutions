...
while True:
        ...
        for j in range(1, len(grid[i])-1):
            if i == 0:
                ...
                if ls1[i][j] == "#":
                    ...
                    if ls1[i][j-1] != "#" and ls1[i][j+1] != "#" and ls1[i+1][j] != "#" and ls1[i+1][j+1] != "#" and ls1[i-1][j-1] != "#":
                        grid[i][j] = "#"
            else: #i != 0 and j != 0 and i != len(grid):
                if ls1[i][j] == "#":
                    count = 0
                    if ls1[i][j-1] == "#":
                        count += 1
                    ...
                    if ls1[i][j-1] != "#" and ls1[i][j+1] != "#" and ls1[i+1][j] != "#" and ls1[i+1][j+1] != "#" and ls1[i+1][j-1] != "#" and ls1[i-1][j] != "#" and ls1[i-1][j-1] != "#" and ls1[i-1][j+1] != "#":
                        grid[i][j] = "#"
    ...
    for i in range(1, len(grid[-1])-1):
        if ls1[-1][i] == "#":
            ...
            if ls1[-1][i-1] != "#" and ls1[-1][i+1] != "#" and ls1[-2][i] != "#" and ls1[-2][i+1] != "#" and \
                    ls1[-2][i-1] != "#":
                grid[-1][i] = "#"
    ...
    for i in range(1, len(grid)-1):
        if ls1[i][0] == "#":
            ...
            if ls1[i-1][0] != "#" and ls1[i-1][1] != "#" and ls1[i][1] != "#" and ls1[i+1][1] != "#" and \
                    ls1[i+1][0] != "#":
                grid[i][0] = "#"
    ...
    for i in range(1, len(grid)-1):
        if ls1[i][-1] == "#":
            ...
            if ls1[i-1][-1] != "#" and ls1[i-1][-2] != "#" and ls1[i][-2] != "#" and ls1[i+1][-2] != "#" and \
                    ls1[i+1][-1] != "#":
                grid[i][-1] = "#"
    #print(grid)
    #print(ls1
    if ls1 == grid:
        break
    ls1 = copy.deepcopy(grid)


'''for i in grid:
    print(i)'''

t = sum(x.count("#") for x in grid)
print(t+1)
