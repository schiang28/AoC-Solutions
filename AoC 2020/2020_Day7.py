...
bag = bags.split(".")
ls = []
lines = [line.strip() for line in bag]
#print(lines)

'''
for a in lines:
    key = "shiny gold"
    if key in a and a.split()[0] != key.split()[0] and a.split()[1] != key.split()[1]:
        print(a)
        # key = a.split(' bags contain')[0]
        ls.append(a)
        for b in lines:
            if a.split(' bags contain')[0] in b and b.split(' bags contain')[0] != a.split(' bags contain')[0]:
                print(b)
                ls.append(b)
                for c in lines:
                    if b.split(' bags contain')[0] in c and c.split(' bags contain')[0] != b.split(' bags contain')[0]:
                        print(c)
                        ls.append(c)
                        for d in lines:
                            if c.split(' bags contain')[0] in d and d.split(' bags contain')[0] != \
                                    c.split(' bags contain')[0]:
                                print(d)
                                ls.append(d)
                                for e in lines:
                                    if d.split(' bags contain')[0] in e and e.split(' bags contain')[0] != \
                                            d.split(' bags contain')[0]:
                                        print(e)
                                        ls.append(e)
                                        for f in lines:
                                            if e.split(' bags contain')[0] in f and f.split(' bags contain')[0] != \
                                                    e.split(' bags contain')[0]:
                                                print(f)
                                                ls.append(f)
                                                for g in lines:
                                                    if f.split(' bags contain')[0] in g and g.split(' bags contain')[
                                                        0] != \
                                                            f.split(' bags contain')[0]:
                                                        print(g)
                                                        ls.append(g)
                                                        for h in lines:
                                                            if g.split(' bags contain')[0] in h and \
                                                                    h.split(' bags contain')[0] != \
                                                                    g.split(' bags contain')[0]:
                                                                print(h)
                                                                ls.append(h)
                                                                for i in lines:
                                                                    if h.split(' bags contain')[0] in i and \
                                                                            i.split(' bags contain')[0] != \
                                                                            h.split(' bags contain')[0]:
                                                                        print(i)
                                                                        ls.append(i)
                                                                        for j in lines:
                                                                            if i.split(' bags contain')[0] in j and \
                                                                                    j.split(' bags contain')[0] != \
                                                                                    i.split(' bags contain')[0]:
                                                                                print(j)
                                                                                ls.append(j)
                                                                                for k in lines:
                                                                                    if j.split(' bags contain')[
                                                                                        0] in k and \
                                                                                            k.split(' bags contain')[
                                                                                                0] != \
                                                                                            j.split(' bags contain')[0]:
                                                                                        print(k)
                                                                                        ls.append(k)
...
for a in lines:
    ...
    if key in a and a.split()[0] == key.split()[0] and a.split()[1] == key.split()[1]:
        #print(a)
        s = a.split(' bags contain ')[1].split(', ')
        #print(s)
        for a1 in range(0, len(s)):
            p = s[a1].split()[1] + " " + s[a1].split()[2]
            total = int(s[a1][0])
            for a2 in lines:
                if p in a2 and a2.split(' bags contain')[0] == p:
                    #print(a2)
                    p1 = a2.split(' bags contain ')[1].split(', ')
                    #print(p1)
                    count = 0
                    for a3 in range(0, len(p1)):
                        if p1[a3][0] != "n":
                            p2 = p1[a3].split()[1] + " " + p1[a3].split()[2]
                            count += int(p1[a3][0])
                            for a4 in lines:
                                if p2 in a4 and a4.split(' bags contain')[0] == p2:
                                    #print(a4)
                                    p3 = a4.split(' bags contain ')[1].split(', ')
                                    for a5 in range(0, len(p3)):
                                        if p3[a5][0] != 'n':
                                            p4 = p3[a5].split()[1] + " " + p3[a5].split()[2]
                                            total = int(p3[a5][0])

                        else:
                            count = total
                    print("t and c", total, count)
                    total_list.append(total)
                    count_list.append(count)

for i in range(0, len(count_list)):
    sum = sum + total_list[i] + (total_list[i] * count_list[i])
